...
import { PERSONALITIES, TIERS, TIER_CONFIG, ATTRS, MEDIA_RANGES } from '../../data/personalities'
    ...
    <div style={{ padding: '12px 14px', background: '#0a0d14', borderTop: '1px solid #21262d' }}>
      ...
      <div style={{ display: 'flex', gap: 14, marginBottom: 12 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 10, color: '#484f58', marginBottom: 3 }}>Styles medias</div>
          ...
          <div key={a.key}>
            <div style={{ fontSize: 10, color: '#484f58', marginBottom: 3 }}>
              ...
              {p.avg?.[a.key] !== undefined && (
                <span style={{ color: '#30363d', marginLeft: 4 }}>({p.avg[a.key]})</span>
              )}
            </div>
    ...
    <div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          <span style={{ fontSize: 20, width: 28, textAlign: 'center', flexShrink: 0 }}>{p.emoji}</span>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
              ...
              <span style={{ fontSize: 9, color: '#30363d' }}>{p.enName}</span>
            </div>
          ...
          <span style={{ color: '#30363d', fontSize: 12, marginLeft: 4 }}>{open ? '▲' : '▼'}</span>
        </div>
      </div>
          ...
          {search && (
            <button
              ...
              style={{
                ...
                color: '#7d8590', fontSize: 16, lineHeight: 1, padding: 0,
              }}
            >✕</button>
          )}
        </div>
